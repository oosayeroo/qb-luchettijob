...
----///////////ITEM AMOUNTS///////////---------------
    ...
    Items = {    --edit prices in this list to your economy
        ...
        slots = 12,
        items = {
            [1] = {name = "cheese-wheel",price = 10,amount = 50,info = {},type = "item",slot = 1,},
            [2] = {name = "salad-box",price = 15,amount = 50,info = {},type = "item",slot = 2,},
            [3] = {name = "dough",price = 5,amount = 50,info = {},type = "item",slot = 3,},
            [4] = {name = "meat-tray",price = 40,amount = 50,info = {},type = "item",slot = 4,},
            [5] = {name = "pasta",price = 5,amount = 50,info = {},type = "item",slot = 5,},
            [6] = {name = "glass-box",price = 10,amount = 50,info = {},type = "item",slot = 6,},
            [7] = {name = "pcocktail-sauce",price = 2,amount = 50,info = {},type = "item",slot = 7,},
            [8] = {name = "tomato-box",price = 15,amount = 50,info = {},type = "item",slot = 8,},
            [9] = {name = "potato-sack",price = 15,amount = 50,info = {},type = "item",slot = 9,},
            [10] = {name = "cream-sauce",price = 2,amount = 50,info = {},type = "item",slot = 10,},
            [11] = {name = "pineapple",price = 2,amount = 50,info = {},type = "item",slot = 11,},
            [12] = {name = "pepperoni",price = 2,amount = 50,info = {},type = "item",slot = 12,},
        }
    }
}
